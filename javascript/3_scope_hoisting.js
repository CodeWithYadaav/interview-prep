// Hoisting in JavaScript is a behavior where variables and function declarations are moved to the top of their scope before the code is executed. 
// This means you can use variables or functions before they are defined in the code.
...
// In the code above, x is declared after the console.log statement, but due to hoisting, JavaScript treats it as if the declaration (var x;) is at the top. 
// However, only the declaration is hoisted, not the assignment, so the output is undefined.
